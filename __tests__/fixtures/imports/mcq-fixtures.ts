export interface McqTextFixture {
  name: string
  text: string
...
export const answerBeforeOptionsPdfMcqText = `
...
Explanation: Possibilism emphasises human agency with natural limits.
`

export const statementStyleMcqText = `
...
export const markdownStyledPdfMcqText = `
...
export const decimalContinuationMcqText = `
...
export const markdownHeadingMcqText = `
# CUET MCQs - Chapter 5:
...
export const inlineQuestionDocxMcqText = `
...
Answer: B.
Question: The sale of goods directly to consumers is called:A) Wholesale tradeB) Retail tradeC) Import-export businessD) Bartering
Answer: B.
`

export const inlineQNumberMcqText = `
...
export const quotedInlineQNumberMcqText = `
...
export const lowercaseListStemMcqText = `
...
export const numberedStatementStemMcqText = `
...
export const headerOnlyAssertionReasonMcqText = `
Q1.
...
Answer: (1) Both A and R are true and R is the correct explanation of A
`
export const chemUnit7StyleMcqText = `
...
Ques 5: Which of the following is an appropriate set of reactants for the preparation of 2-methylprop-1-ene instead of an ether?
...
`
export const regressionFixtures: McqTextFixture[] = [
  ...
  { name: 'decimalContinuationMcqText', text: decimalContinuationMcqText },
  { name: 'markdownHeadingMcqText', text: markdownHeadingMcqText, expectedCount: 5 },
  { name: 'inlineQuestionDocxMcqText', text: inlineQuestionDocxMcqText },
  { name: 'inlineQNumberMcqText', text: inlineQNumberMcqText },
  { name: 'quotedInlineQNumberMcqText', text: quotedInlineQNumberMcqText },
  { name: 'lowercaseListStemMcqText', text: lowercaseListStemMcqText },
  { name: 'numberedStatementStemMcqText', text: numberedStatementStemMcqText },
  { name: 'headerOnlyAssertionReasonMcqText', text: headerOnlyAssertionReasonMcqText },
  { name: 'chemUnit7StyleMcqText', text: chemUnit7StyleMcqText }
]
